...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    ...
    LSFT(KC_LEFT_ALT), KC_TRANSPARENT, KC_LEFT_GUI, TD(DANCE_3), MT(MOD_LSFT, KC_BSLS), TD(DANCE_4), KC_NO, TD(DANCE_5), TD(DANCE_6), MT(MOD_RSFT, KC_QUOTE), MT(MOD_RCTL, KC_SLASH), KC_EQUAL
),
  ...
  [_LOWER] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_BSLS, KC_LEFT_SHIFT, KC_TRANSPARENT, KC_NO, KC_KP_COMMA, KC_KP_0, KC_KP_DOT, KC_MINUS, KC_EQUAL
),
