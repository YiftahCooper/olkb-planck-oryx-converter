// Converted from Oryx to QMK Planck Grid
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    ...
    TD(DANCE_0), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, TT(1),
    DUAL_FUNC_0, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, TD(DANCE_1), TD(DANCE_2),
    LSFT(KC_LEFT_ALT), KC_TRANSPARENT, KC_LEFT_GUI, TD(DANCE_3), MT(MOD_LSFT, KC_BSLS), TD(DANCE_4), TD(DANCE_4), TD(DANCE_5), TD(DANCE_6), MT(MOD_RSFT, KC_QUOTE), MT(MOD_RCTL, KC_SLASH), KC_EQUAL
),

  [_LOWER] = LAYOUT_planck_grid(
    KC_TILD, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_TRANSPARENT,
    KC_DELETE, KC_HOME, KC_UP, KC_END, KC_PAGE_UP, KC_KP_ASTERISK, KC_KP_PLUS, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_EQUAL, KC_TRANSPARENT,
    KC_BSPC, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDN, KC_KP_SLASH, KC_KP_MINUS, KC_KP_1, KC_KP_2, KC_KP_3, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_BSLS, KC_LEFT_SHIFT, KC_TRANSPARENT, KC_TRANSPARENT, KC_KP_COMMA, KC_KP_0, KC_KP_DOT, KC_MINUS, KC_EQUAL
),
  ...
  [_ADJUST] = LAYOUT_planck_grid(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_DELETE, KC_TRANSPARENT, QK_AUDIO_ON, QK_AUDIO_OFF, AU_TOGG, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, QK_BOOT,
    KC_TRANSPARENT, KC_TRANSPARENT, QK_MUSIC_ON, QK_MUSIC_OFF, MU_TOGG, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
),
