...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_ESCAPE,TD(DANCE_0),KC_A,KC_S,KC_D,KC_F,KC_G,KC_H,KC_J,KC_K,KC_L,KC_SCLN,TT(1),DUAL_FUNC_0,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_N,KC_M,KC_COMMA,KC_DOT,TD(DANCE_1),TD(DANCE_2),LSFT(KC_LEFT_ALT),KC_TRANSPARENT,KC_LEFT_GUI,TD(DANCE_3),MT(MOD_LSFT, KC_BSLS),TD(DANCE_4),KC_NO,TD(DANCE_5),TD(DANCE_6),MT(MOD_RSFT, KC_QUOTE),MT(MOD_RCTL, KC_SLASH),KC_EQUAL),

  [_LOWER] = LAYOUT_planck_grid(KC_TILD,KC_1,KC_2,KC_3,KC_4,KC_5,KC_6,KC_7,KC_8,KC_9,KC_0,KC_TRANSPARENT,KC_DELETE,KC_HOME,KC_UP,KC_END,KC_PAGE_UP,KC_KP_ASTERISK,KC_KP_PLUS,KC_KP_4,KC_KP_5,KC_KP_6,KC_KP_EQUAL,KC_TRANSPARENT,KC_BSPC,KC_LEFT,KC_DOWN,KC_RIGHT,KC_PGDN,KC_KP_SLASH,KC_KP_MINUS,KC_KP_1,KC_KP_2,KC_KP_3,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_BSLS,KC_LEFT_SHIFT,KC_TRANSPARENT,KC_NO,KC_KP_COMMA,KC_KP_0,KC_KP_DOT,KC_MINUS,KC_EQUAL),

  [_RAISE] = LAYOUT_planck_grid(KC_TRANSPARENT,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_NO,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT),
